...
[![StyleCI](https://styleci.io/repos/75414626/shield?branch=5.1&style=flat)](https://styleci.io/repos/75414626)
[![Build Status](https://travis-ci.org/dmitry-ivanov/laravel-testing-tools.svg?branch=5.1)](https://travis-ci.org/dmitry-ivanov/laravel-testing-tools)
[![Coverage Status](https://coveralls.io/repos/github/dmitry-ivanov/laravel-testing-tools/badge.svg?branch=5.1)](https://coveralls.io/github/dmitry-ivanov/laravel-testing-tools?branch=5.1)
...
1. Install package through `composer`:
    ...
    ```shell
    composer require --dev "illuminated/testing-tools:5.1.*"
    ```
